...
// app.use(requestLogger) // Personal first middleware made into use (which is declare above)
...
// made to generate random unique ids (but not used anymore)
// const generateId = () => {
